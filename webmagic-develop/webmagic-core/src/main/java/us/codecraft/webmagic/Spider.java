...
public class Spider implements Runnable, Task {
    ...
    private SpiderLogic logic = new SpiderLogic(this);
    ...
    public void test(String... urls) {
        this.logic.initComponent();
        if (urls.length > 0) {
            for (String url : urls) {
                this.logic.processRequest(new Request(url));
            }
        }
    }
     ...
     * @return this
     */
    public Spider setNbThread(int threadNum) {
        this.status.checkIfRunning();
     ...
     * @return this
     */
    public Spider setNbthread(ExecutorService executorService, int threadNum) {
        this.status.checkIfRunning();
        this.threadNum = threadNum;
        if (threadNum <= 0) {
            throw new IllegalArgumentException("threadNum should be more than one!");
     ...
     * @see us.codecraft.webmagic.SpiderStatus.Status
     * @since 0.4.1
     */
    public SpiderStatus.Status getStatus() {
    ...
    public Spider setEmptySleepTime(long emptySleepTime) {
        ...
        this.logic.setEmptySleepTime(emptySleepTime);
        return this;
    }
}