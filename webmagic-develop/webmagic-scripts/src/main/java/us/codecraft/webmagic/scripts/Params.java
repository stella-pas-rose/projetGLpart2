...
public class Params {
   ...
   /**
    * associe au sein d'une HashMap alias un langage à ses alias
    */
   public Params() {
   ...
   /**
    * Cette méthode permet de récupérer le langage associé à l'alias passé en argument
    * @param arg un alias d'un langage
    */
